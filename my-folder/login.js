document.addEventListener('DOMContentLoaded', () => {
  ...
  StudyAuth.getCurrentUser().then(user => {
  ...
  signinBtn.addEventListener('click', async () => {
    ...
    try {
      await StudyAuth.signIn(email, password);
      redirectAfterAuth();
    } catch (err) {
  ...
  signupBtn.addEventListener('click', async () => {
    ...
    try {
      await StudyAuth.signUp(email, password, name);
      redirectAfterAuth();
    } catch (err) {
      showMsg(msgBox, err.message, 'error');
  ...
  resetBtn.addEventListener('click', async () => {
    ...
    try {
      await StudyAuth.sendPasswordReset(email);
