 ...
 *
 * ── SETUP ──────────────────────────────────────────────────────────────────
 * Replace YOUR_FIREBASE_API_KEY with the Web API Key from your Firebase
 * project: console.firebase.google.com → Project Settings → General
 */
...
const StudyAuth = {
  ...
  async isAuthenticated() {
    return !!(await StudyAuth.getCurrentUser());
  }
};
